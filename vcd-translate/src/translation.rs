...
mod tests {
    ...
    fn negative_integers_parse_correctly() {
        ...
        assert_eq!(translated, MaybeValue::Value(BigInt::from(-5i32)));
    }
            ...
            members: vec![
                (
                    ...
                    ConcreteType::Single {
                        base: PrimitiveType::Int,
                        params: vec![
                            ConcreteType::Integer(-16.to_bigint()),
                            ConcreteType::Integer(15.to_bigint()),
                        ],
                    },
                ),
                (
                    ...
                    ConcreteType::Single {
                        base: PrimitiveType::Int,
                        params: vec![
                            ConcreteType::Integer(-4.to_bigint()),
                            ConcreteType::Integer(3u32.to_bigint()),
                        ],
                    },
                ),
            ],
