...
pub enum ConstGeneric {
    ...
    IntBitsFor(Box<Loc<ConstGeneric>>),
    UintBitsFor(Box<Loc<ConstGeneric>>),
    Eq(Box<Loc<ConstGeneric>>, Box<Loc<ConstGeneric>>),
    NotEq(Box<Loc<ConstGeneric>>, Box<Loc<ConstGeneric>>),
    Lt(Box<Loc<ConstGeneric>>, Box<Loc<ConstGeneric>>),
    Gt(Box<Loc<ConstGeneric>>, Box<Loc<ConstGeneric>>),
    Le(Box<Loc<ConstGeneric>>, Box<Loc<ConstGeneric>>),
    Ge(Box<Loc<ConstGeneric>>, Box<Loc<ConstGeneric>>),
...
impl std::fmt::Display for ConstGeneric {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ConstGeneric::Lt(l, r) => write!(f, "({l} < {r})"),
            ConstGeneric::Gt(l, r) => write!(f, "({l} > {r})"),
            ConstGeneric::Le(l, r) => write!(f, "({l} <= {r})"),
            ConstGeneric::Ge(l, r) => write!(f, "({l} >= {r})"),
